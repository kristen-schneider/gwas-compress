...
IN_FILE = '/home/krsc0813/projects/gwas-compress/data/hundred.tsv'
    ...
    for block_i in range(len(ff)):
        ...
        for column_i in range(len(curr_block)):
            ...
            if column_type == 1:
                ...
                decomp = pyfastpfor_sandbox.kristen(codec, typed_column, len(typed_column), 10*16, codec_dict, block_i)
                #print('decomp: ', decomp)
