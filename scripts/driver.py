...
def write_header_compressed(in_file, block_size):
    ...
    #o_file.write(compress.compress_data(bytes(header), 0))
...
header=write_header_compressed(IN_FILE, BLOCK_SIZE)
