...
def column_compression_main(column_i, column, column_codec,
    ...
    print(column_codec, "col"+str(column_i), 'compression_time', column_i_TIME)
    print(column_codec, "col"+str(column_i), 'compression_ratio', column_i_mn)
...
def compress_serialized(typed_column, column_codec, compression_data_type, column_num_bytes):
    ...
    """
    serialized_column = serialize_body.serialize_list(typed_column, compression_data_type, column_num_bytes)
